...
<body>
			...
			<table class="search-tab" width="1490px">
				<tr>
					...
					<th width="100"><button name="sub" id="searchbutton"
							class="layui-btn layui-btn-normal">查询</button></th>
					<td align="right">
						<div class="result-list">
							<a id="addstu" class="layui-btn" href='javascript:void(0)'> <i
								class="layui-icon">&#xe608;</i>新增学生
							</a> <a id="batchDel" class="layui-btn" href='javascript:void(0)'>
								<i class="layui-icon">&#xe640;</i>批量删除
							</a> <a id="updateOrd" class="layui-btn" href='javascript:void(0)'>
	...
	<div id="addstudent" style="display:none">
		...
		<div class="layui-input-block">
			<input type="text" name="sname" id="sname" lay-verify="required"
